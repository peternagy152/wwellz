...
/* Smarty version 4.3.4, created on 2024-12-20 20:58:45
  from '/home/wwellzc1/public_html/modules/ets_multilayerslider/views/templates/hook/multilayerslider.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.4',
  'unifunc' => 'content_6765be65204691_33429554',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '17a2547abc1f269335178ffada0530223449b87e' => 
    array (
      0 => '/home/wwellzc1/public_html/modules/ets_multilayerslider/views/templates/hook/multilayerslider.tpl',
      1 => 1704981946,
      2 => 'file',
    ),
  ),
...
function content_6765be65204691_33429554 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->compiled->nocache_hash = '18640302026765be651ac8e4_67138018';
echo '<script'; ?>
 type="text/javascript">
    var width_slider = <?php echo htmlspecialchars((string) call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( $_smarty_tpl->tpl_vars['mls_width']->value )), ENT_QUOTES, 'UTF-8');?>
;
    var height_slider = <?php echo htmlspecialchars((string) call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( $_smarty_tpl->tpl_vars['mls_height']->value )), ENT_QUOTES, 'UTF-8');?>
;
<?php echo '</script'; ?>
>
...
<div class="ets_multilayerslider <?php if ($_smarty_tpl->tpl_vars['mls_configs']->value['ETS_MLS_SLIDER_TYPE'] == 'full') {?>hidden<?php }?>">
    ...
    <div data-max-slide-time="<?php echo htmlspecialchars((string) call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( $_smarty_tpl->tpl_vars['mls_max_slide_time']->value )), ENT_QUOTES, 'UTF-8');?>
...
" style="width: <?php echo htmlspecialchars((string) call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( $_smarty_tpl->tpl_vars['mls_width']->value )), ENT_QUOTES, 'UTF-8');?>
px; height: <?php echo htmlspecialchars((string) call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( $_smarty_tpl->tpl_vars['mls_height']->value )), ENT_QUOTES, 'UTF-8');?>
...
;<?php }?>" <?php echo Module::getInstanceByName('ets_multilayerslider')->hookDisplayMLSConfigs();?>
>
...
" data-slide-order="<?php echo htmlspecialchars((string) call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( $_smarty_tpl->tpl_vars['ik']->value )), ENT_QUOTES, 'UTF-8');?>
" data-max-layer-in="<?php echo htmlspecialchars((string) call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( $_smarty_tpl->tpl_vars['slide']->value['max_layer_in'] )), ENT_QUOTES, 'UTF-8');?>
" data-max-layer-out="<?php echo htmlspecialchars((string) call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( $_smarty_tpl->tpl_vars['slide']->value['max_layer_out'] )), ENT_QUOTES, 'UTF-8');?>
...
" data-id-slide="<?php echo htmlspecialchars((string) call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( $_smarty_tpl->tpl_vars['slide']->value['id_slide'] )), ENT_QUOTES, 'UTF-8');?>
...
}?> item_<?php echo htmlspecialchars((string) call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( $_smarty_tpl->tpl_vars['ik']->value )), ENT_QUOTES, 'UTF-8');?>
 mls_slide_<?php echo htmlspecialchars((string) call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( $_smarty_tpl->tpl_vars['slide']->value['id_slide'] )), ENT_QUOTES, 'UTF-8');?>
...
?>
                            <?php if ($_smarty_tpl->tpl_vars['layer']->value['layer_type'] == 'image' && $_smarty_tpl->tpl_vars['layer']->value['image'] || $_smarty_tpl->tpl_vars['layer']->value['layer_type'] != 'image' && $_smarty_tpl->tpl_vars['layer']->value['content_layer']) {?>
                                <div class="msl_layer_front msl_layer_<?php echo htmlspecialchars((string) call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( $_smarty_tpl->tpl_vars['layer']->value['id_layer'] )), ENT_QUOTES, 'UTF-8');?>
...
px; right: auto;<?php }?> float:left; bottom: auto; z-index: <?php echo htmlspecialchars((string) call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( $_smarty_tpl->tpl_vars['layer']->value['sort_order'] )), ENT_QUOTES, 'UTF-8');?>
...
" data-id-layer="<?php echo htmlspecialchars((string) call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( $_smarty_tpl->tpl_vars['layer']->value['id_layer'] )), ENT_QUOTES, 'UTF-8');?>
" 
...
" style="<?php if ($_smarty_tpl->tpl_vars['layer']->value['width']) {?>width: <?php echo htmlspecialchars((string) call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'floatval' ][ 0 ], array( $_smarty_tpl->tpl_vars['layer']->value['width'] )), ENT_QUOTES, 'UTF-8');?>
px;<?php }
if ($_smarty_tpl->tpl_vars['layer']->value['height']) {?>height: <?php echo htmlspecialchars((string) call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'floatval' ][ 0 ], array( $_smarty_tpl->tpl_vars['layer']->value['height'] )), ENT_QUOTES, 'UTF-8');?>
px;<?php }?>" /><?php if ($_smarty_tpl->tpl_vars['layer']->value['link']) {?></a><?php }?>
...
;<?php }?>
                                        "><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'nl2br' ][ 0 ], array( $_smarty_tpl->tpl_vars['layer']->value['content_layer'] ));?>
...
;<?php }?>
                                            <?php if ($_smarty_tpl->tpl_vars['layer']->value['padding']) {?>padding:<?php echo htmlspecialchars((string) call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['layer']->value['padding'],'html','UTF-8' )), ENT_QUOTES, 'UTF-8');?>
;<?php }?>
                                            <?php if ($_smarty_tpl->tpl_vars['layer']->value['box_radius']) {?>border-radius:<?php echo htmlspecialchars((string) call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( $_smarty_tpl->tpl_vars['layer']->value['box_radius'] )), ENT_QUOTES, 'UTF-8');?>
px;<?php }?>
                                        "><?php echo $_smarty_tpl->tpl_vars['layer']->value['content_layer'];?>
...
ajax-loader.gif"/></div>
        ...
        <?php if ($_smarty_tpl->tpl_vars['mls_configs']->value['ETS_MLS_ENABLE_NEXT_PREV']) {?>
            <div class="mls_nav">
                <div data-title="&#xE314;" class="mls_prev" style="<?php if ($_smarty_tpl->tpl_vars['mls_configs']->value['ETS_MLS_SLIDER_BUTTON_COLOR']) {?>background-color: <?php echo htmlspecialchars((string) call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['mls_configs']->value['ETS_MLS_SLIDER_BUTTON_COLOR'],'html','UTF-8' )), ENT_QUOTES, 'UTF-8');?>
;<?php } else { ?>#000000;<?php }?>"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Prev','mod'=>'ets_multilayerslider'),$_smarty_tpl ) );?>
</div>
                <div data-title="&#xE315;" class="mls_next" style="<?php if ($_smarty_tpl->tpl_vars['mls_configs']->value['ETS_MLS_SLIDER_BUTTON_COLOR']) {?>background-color: <?php echo htmlspecialchars((string) call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['mls_configs']->value['ETS_MLS_SLIDER_BUTTON_COLOR'],'html','UTF-8' )), ENT_QUOTES, 'UTF-8');?>
;<?php } else { ?>#000000;<?php }?>"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Next','mod'=>'ets_multilayerslider'),$_smarty_tpl ) );?>
</div>
            </div>
        <?php }?>
...
?>
                    <?php $_smarty_tpl->_assignInScope('ik', $_smarty_tpl->tpl_vars['ik']->value+1);?>
                    <div class="mls_pag_button" style="background-color: <?php if ((isset($_smarty_tpl->tpl_vars['mls_configs']->value['ETS_MLS_SLIDER_BUTTON_COLOR'])) && $_smarty_tpl->tpl_vars['mls_configs']->value['ETS_MLS_SLIDER_BUTTON_COLOR']) {
...
} else { ?>#000000;<?php }?>" class="mls_pag_<?php echo htmlspecialchars((string) call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( $_smarty_tpl->tpl_vars['ik']->value )), ENT_QUOTES, 'UTF-8');?>
" data-slide-order="<?php echo htmlspecialchars((string) call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( $_smarty_tpl->tpl_vars['ik']->value )), ENT_QUOTES, 'UTF-8');?>
" data-id-slide="<?php echo htmlspecialchars((string) call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( $_smarty_tpl->tpl_vars['slide']->value['id_slide'] )), ENT_QUOTES, 'UTF-8');?>
"><?php echo htmlspecialchars((string) call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( $_smarty_tpl->tpl_vars['ik']->value )), ENT_QUOTES, 'UTF-8');?>
</div>
                <?php
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
